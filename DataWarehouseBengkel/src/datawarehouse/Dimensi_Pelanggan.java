 ...
 * @author user
 */
public class Dimensi_Pelanggan extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Dimensi_Pelanggan
     */
    public Dimensi_Pelanggan() {
        initComponents();
    ...
    public void tampiltabel(){
        ...
        tb.addColumn("TELP_PELANGGAN");
        tb.addColumn("ALAMAT_PELANGGAN");
        tableOrder.setModel(tb); 
        try{
            String sql = ("select * from dimensi_PELANGGAN;");
            rs = st.executeQuery(sql);
            while (rs.next()){
                tb.addRow(new Object[]{
                    rs.getString("ID_PELANGGAN"),
                    rs.getString("NAMA_PELANGGAN"),
                    rs.getString("TELP_PELANGGAN"), 
    ...
    private void initComponents() {
        ...
        TReport5.setForeground(new java.awt.Color(204, 204, 204));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Dimensi_Pelanggan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
