 ...
 * @author user
 */
public class Dimensi_Barang extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Dimensi_Barang
     */
    ...
    public void tampiltabel(){
        ...
        tb.addColumn("NAMA_BARANG");
        tb.addColumn("STOK_BARANG");
        tb.addColumn("SATUAN");
        tb.addColumn("HARGA JUAL");
        tb.addColumn("HARGA BELI");
        tableOrder.setModel(tb); 
        try{
            String sql = ("select * from dimensi_BARANG;");
...
//public void transformcabang1(){
//    //TRANSFORM
//    try{
//            Connection con = DriverManager.getConnection("jdbc:mysql://localhost/datawarehouse_bengkel_asikgen_otomotif", "root", "");
//            con.createStatement().executeUpdate("insert into DIMENSI_BARANG (`NAMA_BARANG`,`HARGA_JUAL`,`HARGA_BELI`, `STOK_BARANG`, SATUAN)"
...
//}
    ...
    private void initComponents() {
        ...
        TReport3.setForeground(new java.awt.Color(204, 204, 204));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Dimensi_Barang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
