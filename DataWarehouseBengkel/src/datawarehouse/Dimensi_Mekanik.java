 ...
 * @author user
 */
public class Dimensi_Mekanik extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Dimensi_Mekanik
     */
    public Dimensi_Mekanik() {
        initComponents();
    ...
    public void tampiltabel(){
        ...
        tb.addColumn("ID_MEKANIK");
        tb.addColumn("NAMA_MEKANIK");
        tb.addColumn("TELP_MEKANIK");
        tb.addColumn("ALAMAT_MEKANIK");
        tableOrder.setModel(tb); 
        try{
            String sql = ("select * from dimensi_MEKANIK;");
            rs = st.executeQuery(sql);
            while (rs.next()){
                tb.addRow(new Object[]{
                    rs.getString("ID_MEKANIK"),
                    rs.getString("NAMA_MEKANIK"),
                    rs.getString("TELP_MEKANIK"), 
                    rs.getString("ALAMAT_MEKANIK")
                });   
            }
        }catch(Exception e){
    ...
    private void initComponents() {
        ...
        TReport4.setForeground(new java.awt.Color(204, 204, 204));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Dimensi_Mekanik.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
